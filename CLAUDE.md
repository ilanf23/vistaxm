...
- **Never use em dashes (`—`)** anywhere: not in site copy, code, comments, docs, or commit messages. Use a colon, comma, semicolon, or restructure the sentence instead. This applies to all text you write or edit in this repo.
