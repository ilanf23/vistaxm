              ...
              <FadeIn className="h-full">
                <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl hairline bg-white p-8 md:p-9 card-lift">
                  ...
                  <p className="mt-3 leading-relaxed text-[color:var(--ink-soft)]">
                    A fixed, fast first wave. We stand up your program, deliver your certified NPS
                    and your first account-level revenue signals, and hand you a prioritized list of
                ...
                <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl bg-[color:var(--navy-deep)] p-8 text-white grain card-lift md:p-9">
                  ...
                  <div className="relative flex h-full flex-col">
                    ...
                    <p className="mt-3 leading-relaxed text-white/75">
                      The ongoing program that keeps finding and protecting revenue, wave after
                      wave. Choose the scope that fits your book. Continuous signal, benchmark
                      tracking, and quarterly reviews, all run by us.
                    </p>
