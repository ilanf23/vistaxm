...
const LEADERS: {
...
}[] = [
  {
    ...
    bio: [
      ...
      "Erik is a seasoned global executive with more than 30 years' experience across the technology and services industries. He has a proven track record of success and a relentless drive for innovation, customer satisfaction, and continuous improvement. Erik previously served as Senior Vice President & Global Head of High-Tech, Telco, and Media at Qualtrics.",
      "Prior to Qualtrics, Erik held multiple senior leadership positions at HPE, Inc, a multinational information technology leader, including Global Vice President of Customer Experience and Global Vice President of Software Defined and Cloud Center of Excellence. Earlier in his career Erik held leadership roles with Cisco.",
