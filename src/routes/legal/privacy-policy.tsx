...
const PAGE_TITLE = "Privacy Policy | VistaXM";
const PAGE_DESC =
  "VistaXM Privacy Notice: how we access, collect, store, use, and share your personal information when you use our Services.";
...
function PrivacyPolicyPage() {
  return (
    <LegalPage title="Privacy Policy">
      ...
      <p>
        This Privacy Notice for VistaXM, Inc. (“<strong>we</strong>,” “<strong>us</strong>,” or
      ...
      <ul>
        <li>Visit our website at https://www.vistaxm.com or any website of ours that links to this Privacy Notice</li>
      ...
      <p>
        ...
        prevention, and to comply with the law. We may also process your information for other
      ...
      <p>
        ...
        by visiting https://www.vistaxm.com/contact/, or by contacting us. We will consider and act
      ...
      <p>
        <em><strong>In Short:</strong> Some information — such as your Internet Protocol (IP)
      ...
      <p>
        ...
        https://www.vistaxm.com/legal/cookie-policy.
      </p>
      ...
      <p>
        <em><strong>In Short:</strong> We process your information to provide, improve, and
        administer our Services, communicate with you, for security and fraud prevention, and to
        comply with the law. We process the personal information for the following purposes listed
      ...
      <ul>
        ...
        <li>
          <strong>To enable user-to-user communications.</strong> We may process your information if
      ...
      <p>
        <em><strong>In Short:</strong> We only process your personal information when we believe it
      ...
      <p>
        <em><strong>In Short:</strong> We may use cookies and other tracking technologies to collect
      ...
      <p>
        ...
        cookies is set out in our Cookie Notice: https://www.vistaxm.com/legal/cookie-policy.
      </p>
      ...
      <p>
        ...
        https://tools.google.com/dlpage/gaoptout. For more information on the privacy practices of
      ...
      <p>
        <em><strong>In Short:</strong> We do not knowingly collect data from or market to children
        under 18 years of age or the equivalent age as specified by law in your jurisdiction.</em>
      </p>
      <p>
        We do not knowingly collect, solicit data from, or market to children under 18 years of age
        or the equivalent age as specified by law in your jurisdiction, nor do we knowingly sell
        such personal information. By using the Services, you represent that you are at least 18 or
        the equivalent age as specified by law in your jurisdiction or that you are the parent or
        guardian of such a minor and consent to such minor dependent’s use of the Services. If we
        learn that personal information from users less than 18 years of age or the equivalent age
        as specified by law in your jurisdiction has been collected, we will deactivate the account
        and take reasonable measures to promptly delete such data from our records. If you become
        aware of any data we may have collected from children under age 18 or the equivalent age as
        specified by law in your jurisdiction, please contact us at contactus@vistaxm.com.
      </p>

      <h3>9. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
      <p>
        <em><strong>In Short:</strong> Depending on your state of residence in the US or in some
      ...
      <p>
        ...
        portability; and (v) not to be subject to automated decision-making. If a decision that
        produces legal or similarly significant effects is made solely by automated means, we will
        inform you, explain the main factors, and offer a simple way to request human review. In
      ...
      <p>
        ...
        Cookie Notice: https://www.vistaxm.com/legal/cookie-policy.
      </p>
      <p>If you have questions or comments about your privacy rights, you may email us at contactus@vistaxm.com.</p>
      ...
      <p>
        <em><strong>In Short:</strong> If you are a resident of California, Colorado, Connecticut,
        ...
        have the right to request access to and receive details about the personal information we
        ...
        circumstances by applicable law. More information is provided below.</em>
      </p>
      ...
      <p>
        ...
        reflect the personal information we collect from you.
      </p>
      <div className="overflow-x-auto my-6">
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="border-b border-[color:var(--hairline)]">
              <th className="text-left py-3 pr-4 align-top">Category</th>
              <th className="text-left py-3 pr-4 align-top">Examples</th>
              <th className="text-left py-3 align-top">Collected</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-[color:var(--hairline)]"><td className="py-3 pr-4 align-top">A. Identifiers</td><td className="py-3 pr-4 align-top">Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name</td><td className="py-3 align-top">YES</td></tr>
            <tr className="border-b border-[color:var(--hairline)]"><td className="py-3 pr-4 align-top">B. Personal information as defined in the California Customer Records statute</td><td className="py-3 pr-4 align-top">Name, contact information, education, employment, employment history, and financial information</td><td className="py-3 align-top">NO</td></tr>
            <tr className="border-b border-[color:var(--hairline)]"><td className="py-3 pr-4 align-top">C. Protected classification characteristics under state or federal law</td><td className="py-3 pr-4 align-top">Gender, age, date of birth, race and ethnicity, national origin, marital status, and other demographic data</td><td className="py-3 align-top">NO</td></tr>
            <tr className="border-b border-[color:var(--hairline)]"><td className="py-3 pr-4 align-top">D. Commercial information</td><td className="py-3 pr-4 align-top">Transaction information, purchase history, financial details, and payment information</td><td className="py-3 align-top">NO</td></tr>
            <tr className="border-b border-[color:var(--hairline)]"><td className="py-3 pr-4 align-top">E. Biometric information</td><td className="py-3 pr-4 align-top">Fingerprints and voiceprints</td><td className="py-3 align-top">NO</td></tr>
            <tr className="border-b border-[color:var(--hairline)]"><td className="py-3 pr-4 align-top">F. Internet or other similar network activity</td><td className="py-3 pr-4 align-top">Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements</td><td className="py-3 align-top">NO</td></tr>
            <tr className="border-b border-[color:var(--hairline)]"><td className="py-3 pr-4 align-top">G. Geolocation data</td><td className="py-3 pr-4 align-top">Device location</td><td className="py-3 align-top">NO</td></tr>
            <tr className="border-b border-[color:var(--hairline)]"><td className="py-3 pr-4 align-top">H. Audio, electronic, sensory, or similar information</td><td className="py-3 pr-4 align-top">Images and audio, video or call recordings created in connection with our business activities</td><td className="py-3 align-top">NO</td></tr>
            <tr className="border-b border-[color:var(--hairline)]"><td className="py-3 pr-4 align-top">I. Professional or employment-related information</td><td className="py-3 pr-4 align-top">Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us</td><td className="py-3 align-top">YES</td></tr>
            <tr className="border-b border-[color:var(--hairline)]"><td className="py-3 pr-4 align-top">J. Education Information</td><td className="py-3 pr-4 align-top">Student records and directory information</td><td className="py-3 align-top">NO</td></tr>
            <tr className="border-b border-[color:var(--hairline)]"><td className="py-3 pr-4 align-top">K. Inferences drawn from collected personal information</td><td className="py-3 pr-4 align-top">Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual’s preferences and characteristics</td><td className="py-3 align-top">NO</td></tr>
            <tr><td className="py-3 pr-4 align-top">L. Sensitive personal Information</td><td className="py-3 pr-4 align-top"></td><td className="py-3 align-top">NO</td></tr>
          </tbody>
        </table>
      </div>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          for targeted advertising (or sharing as defined under California’s privacy law), the sale
          of personal data, or profiling in furtherance of decisions that produce legal or similarly
          significant effects (“profiling”)
        </li>
      </ul>
      <p>Depending upon the state where you live, you may also have the following rights:</p>
      <ul>
        <li>Right to access the categories of personal data being processed (as permitted by applicable law, including the privacy laws in Minnesota)</li>
        <li>Right to obtain a list of the categories of third parties to which we have disclosed personal data (as permitted by applicable law, including the privacy laws in California, Delaware, and Maryland)</li>
        <li>Right to obtain a list of specific third parties to which we have disclosed personal data (as permitted by applicable law, including the privacy laws in Minnesota and Oregon)</li>
        <li>Right to review, understand, question, and correct how personal data has been profiled (as permitted by applicable law, including the privacy laws in Minnesota)</li>
        <li>Right to limit use and disclosure of sensitive personal data (as permitted by applicable law, including the privacy laws in California)</li>
        <li>Right to opt out of the collection of sensitive data and personal data collected through the operation of a voice or facial recognition feature (as permitted by applicable law, including the privacy laws in Florida)</li>
      </ul>
      <h4>How to Exercise Your Rights</h4>
      <p>
        To exercise these rights, you can contact us by visiting https://www.vistaxm.com/contact/,
        by emailing us at contactus@vistaxm.com, or by referring to the contact details at the
      ...
      <p>
        ...
        request, you may appeal our decision by emailing us at contactus@vistaxm.com. We will inform
      ...
      <p>
        ...
        writing to us by using the contact details provided in the section “HOW CAN YOU CONTACT US
        ABOUT THIS NOTICE?“
      </p>

      <h3>12. DO WE MAKE UPDATES TO THIS NOTICE?</h3>
      <p>
        <em><strong>In Short:</strong> Yes, we will update this notice as necessary to stay
