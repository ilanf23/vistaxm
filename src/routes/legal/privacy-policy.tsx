...
export const Route = createFileRoute("/legal/privacy-policy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy | VistaXM" },
      {
        name: "description",
        content:
          "VistaXM Privacy Notice: how we access, collect, store, use, and share personal information when you use our Services.",
      },
      { property: "og:title", content: "Privacy Policy | VistaXM" },
      {
    ...
    links: [canonicalLink("/legal/privacy-policy")],
  }),
...
function PrivacyPolicy() {
  return (
    <LegalPage title="Privacy Policy" lastUpdated="August 15, 2025">
      ...
      <ul>
        <li>
          ...
          <a href="https://www.vistaxm.com">https://www.vistaxm.com</a> or any website of ours
      ...
      <p>
        ...
        <a href="mailto:contactus@vistaxm.com">contactus@vistaxm.com</a>.
      </p>
      ...
      <p>
        ...
        fraud prevention, and to comply with the law. We may also process your information for
      ...
      <p>
        ...
        <a href="https://www.vistaxm.com/contact/">https://www.vistaxm.com/contact/</a>, or by
      ...
      <ol className="toc">
        ...
        <li><strong>WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</strong></li>
        ...
        <li><strong>DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</strong></li>
      ...
      <p>
        ...
        <a href="https://www.vistaxm.com/cookie-policy">
          https://www.vistaxm.com/cookie-policy
        </a>
        .
      </p>
      ...
      <p>
        <em>
          ...
          and to comply with the law. We process the personal information for the following
          purposes listed below. We may also process your information for other purposes only
      ...
      <p>
        ...
        submitting a request as described below under section “DO UNITED STATES RESIDENTS
      ...
      <p>
        ...
        <a href="https://www.vistaxm.com/legal/cookie-policy">
      ...
      <p>
        <em>
          ...
          children under 18 years of age or the equivalent age as specified by law in your
          jurisdiction.
        </em>
      </p>
      <p>
      ...
      <p>
        <em>
          ...
          regions, such as the European Economic Area (EEA), United Kingdom (UK), Switzerland,
      ...
      <p>
        ...
        cookies, this could affect certain features or services of our Services. For further
      ...
      <p>
        <em>
          ...
          Texas, Utah, or Virginia, you may have the right to request access to and receive
      ...
      <p>
        ...
        inventory of all personal information we process, please refer to the section “WHAT
      ...
      <ul>
        ...
        <li>
          ...
          applicable law, including the privacy laws in Florida)
        </li>
      </ul>
      ...
      <p>
        ...
        <a href="https://www.vistaxm.com/contact/">https://www.vistaxm.com/contact/</a>, by
        emailing us at <a href="mailto:contactus@vistaxm.com">contactus@vistaxm.com</a>, or by
      ...
      <p>
        ...
        <a href="mailto:contactus@vistaxm.com">contactus@vistaxm.com</a>. We will inform you
      ...
      <p>
        ...
        please visit:{" "}
        <a href="https://www.vistaxm.com/contact/">https://www.vistaxm.com/contact/</a>.
      </p>
    </LegalPage>
  );
}
