...
export const Route = createFileRoute("/legal/terms-of-service")({
  head: () => ({
    meta: [
      { title: "Terms of Service | VistaXM" },
      {
        name: "description",
        content:
          "The legally binding agreement governing your access to and use of VistaXM Services.",
      },
      { property: "og:title", content: "Terms of Service | VistaXM" },
      {
    ...
    links: [canonicalLink("/legal/terms-of-service")],
  }),
...
function TermsOfService() {
  return (
    <LegalPage title="Terms of Service" lastUpdated="August 15, 2025">
      <h2>TERMS OF SERVICE</h2>

      <h2>AGREEMENT TO OUR LEGAL TERMS</h2>
      <p>
        We are VistaXM, Inc. (“<strong>Company</strong>,” “<strong>we</strong>,” “
        <strong>us</strong>,” “<strong>our</strong>“).
      </p>
      <p>
        We operate www.vistaxm.com as well as any other related products and services that
        refer or link to these legal terms (the “<strong>Legal Terms</strong>“) (collectively,
      ...
      <p>
        ...
        personally or on behalf of an entity (“<strong>you</strong>“), and VistaXM, Inc.
      ...
      <p>
        ...
        intellectual property rights and unfair competition laws) and treaties around the
        world.
      </p>
      <p>
      ...
      <p>
        ...
        <a href="mailto:contactus@vistaxm.com">contactus@vistaxm.com</a>. If we ever grant you
        the permission to post, reproduce, or publicly display any part of our Services or
      ...
      <p>
        ...
        jurisdiction in which you reside; (3) you will not access the Services through
        automated or non-human means, whether through a bot, script or otherwise; (4) you will
        not use the Services for any illegal or unauthorized purpose; and (5) your use of the
      ...
      <p>
        You and Company agree that we may access, store, process, and use any information and
      ...
      <p>
        ...
        REGULATION. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SERVICES OR DELETE ANY
      ...
      <p>
        ...
        time and for any reason at our sole discretion without notice. However, we have no
      ...
      <p>
        ...
        Utah, USA. Company and yourself irrevocably consent that the courts of the State of
        Utah shall have exclusive jurisdiction to resolve any dispute which may arise in
      ...
      <p>
        ...
        YOU TO US. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON
