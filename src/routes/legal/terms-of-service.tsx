...
const PAGE_TITLE = "Terms of Service | VistaXM";
const PAGE_DESC =
  "VistaXM Terms of Service: the legal agreement governing your access to and use of the Services provided by VistaXM, Inc.";
...
function TermsPage() {
  return (
    <LegalPage title="Terms of Service">
      ...
      <p>We are VistaXM, Inc. (“<strong>Company</strong>,” “<strong>we</strong>,” “<strong>us</strong>,” “<strong>our</strong>“).</p>
      <p>
        We operate www.vistaxm.com as well as any other related products and services that refer or
        link to these legal terms (the “<strong>Legal Terms</strong>“) (collectively, the
        “<strong>Services</strong>“).
      </p>
      <p>You can contact us by email at contactus@vistaxm.com.</p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether
        personally or on behalf of an entity (“<strong>you</strong>“), and VistaXM, Inc. concerning
      ...
      <p>
        ...
        contactus@vistaxm.com. If we ever grant you the permission to post, reproduce, or publicly
      ...
      <p>
        ...
        means, whether through a bot, script or otherwise; (4) you will not use the Services for
        any illegal or unauthorized purpose; and (5) your use of the Services will not violate any
      ...
      <p>
        ...
        and for any reason at our sole discretion without notice. However, we have no obligation to
      ...
      <p>
        These Legal Terms shall be governed by and defined following the laws of the State of Utah,
        USA. Company and yourself irrevocably consent that the courts of the State of Utah shall
      ...
      <p>
        ...
        informally for at least 30 days before initiating arbitration. Such informal negotiations
      ...
      <p>
        ...
        Legal Terms will not be construed against us by virtue of having drafted them. You hereby
        waive any and all defenses you may have based on the electronic form of these Legal Terms
      ...
      <p>
        ...
        regarding use of the Services, please contact us at contactus@vistaxm.com.
      </p>
    </LegalPage>
  );
}
