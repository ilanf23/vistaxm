...
export const Route = createFileRoute("/legal/cookie-policy")({
  head: () => ({
    meta: [
      { title: "Cookie Policy | VistaXM" },
      {
        name: "description",
        content:
          "How VistaXM uses cookies and similar technologies to recognize you when you visit our website, and how to control them.",
      },
      { property: "og:title", content: "Cookie Policy | VistaXM" },
      {
    ...
    links: [canonicalLink("/legal/cookie-policy")],
  }),
...
function CookiePolicy() {
  return (
    <LegalPage title="Cookie Policy" lastUpdated="August 15, 2025">
      <h2>COOKIE POLICY</h2>
      ...
      <p>
        ...
        <a href="https://www.vistaxm.com">https://www.vistaxm.com</a> (“<strong>Website</strong>
      ...
      <p>
        Cookies set by the website owner (in this case, VistaXM, Inc.) are called
      ...
      <p>
        ...
        contact us at: <a href="mailto:contactus@vistaxm.com">contactus@vistaxm.com</a>
      </p>
    </LegalPage>
  );
}
